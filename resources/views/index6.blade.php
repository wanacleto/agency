        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="header-elements">
              ...
              <div class="main-menu">
                <ul>
                  <li><a href="#">Home <i class="fa-solid fa-angle-down"></i></a>
                    <div class="tp-submenu auhtor-tabpane">
                      <div class="row">
                        <div class="col-lg-12">
                              ...
                              <div class="homemenu-thumb">
                                ...
                                <img src="{{ URL::asset('build/img/all-images/demo-img1.png') }}" alt="">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn12" href="index">Multi Page</a>
                                    <div class="space16"></div>
                                    <a class="header-btn12" href="single-index1" target="_blank">One Page</a>
                                 </div>
                          ...
                          <div class="images">
                            <div class="homemenu-thumb">
                              ...
                              <img src="{{ URL::asset('build/img/all-images/demo-img2.png') }}" alt="">
                               ...
                               <div class="homemenu-btn">
                                  <a class="header-btn12" href="index2">Multi Page</a>
                                  <div class="space16"></div>
                                  <a class="header-btn12" href="single-index2" target="_blank">One Page</a>
                               </div>
                               <div class="space20"></div>
                            </div>
                          </div>
                          <div class="images">
                            <div class="homemenu-thumb">
                              ...
                              <div class="homemenu-btn">
                                <a class="header-btn12" href="index3">Multi Page</a>
                                <div class="space16"></div>
                                <a class="header-btn12" href="single-index3" target="_blank">One Page</a>
                             </div>
                             <div class="space20"></div>
                            </div>
                          </div>
                          <div class="images">
                            <div class="homemenu-thumb">
                              ...
                              <img src="{{ URL::asset('build/img/all-images/demo-img3.png') }}" alt="">
                               ...
                               <div class="homemenu-btn">
                                  <a class="header-btn12" href="index4">Multi Page</a>
                                  <div class="space16"></div>
                                  <a class="header-btn12" href="single-index4" target="_blank">One Page</a>
                               </div>
                               <div class="space20"></div>
                            </div>
                          </div>
                          <div class="images">
                            <div class="homemenu-thumb" style="margin: 0;">
                              ...
                              <img src="{{ URL::asset('build/img/all-images/demo-img4.png') }}" alt="">
                               ...
                               <div class="homemenu-btn">
                                  <a class="header-btn12" href="index5">Multi Page</a>
                                   <div class="space16"></div>
                                  <a class="header-btn12" href="single-index5" target="_blank">One Page</a>
                               </div>
                               <div class="space20"></div>
                            </div>
                          </div>
                          ...
                          <div class="images">
                            <div class="homemenu-thumb">
                              ...
                              <img src="{{ URL::asset('build/img/all-images/demo-img5.png') }}" alt="">
                               ...
                               <div class="homemenu-btn">
                                  <a class="header-btn12" href="index6">Multi Page</a>
                                  <div class="space16"></div>
                                  <a class="header-btn12" href="single-index6" target="_blank">One Page</a>
                               </div>
                            </div>
                          </div>
                          ...
                          <div class="images">
                            <div class="homemenu-thumb">
                              ...
                              <div class="text">
                               ...
                               <div class="homemenu-btn">
                                  <a class="header-btn12" href="index7">Multi Page</a>
                                  <div class="space16"></div>
                                  <a class="header-btn12" href="single-index7" target="_blank">One Page</a>
                               </div>
                            </div>
                          </div>
                        ...
                        <div class="images">
                            <div class="homemenu-thumb">
                              <div class="img1">
                              <img src="{{ URL::asset('build/img/all-images/demo-img7.png') }}" alt="">
                              </div>
                              <div class="text">
                                <h2>NEW</h2>
                              </div>
                               <div class="homemenu-btn">
                                  <a class="header-btn12" href="index8">Multi Page</a>
                                  <div class="space16"></div>
                                  <a class="header-btn12" href="single-index8" target="_blank">One Page</a>
                               </div>
                            </div>
                          </div>
                        ...
                        <div class="images">
                            <div class="homemenu-thumb">
                              ...
                              <div class="text">
                               ...
                               <div class="homemenu-btn">
                                  <a class="header-btn12" href="index9">Multi Page</a>
                                  <div class="space16"></div>
                                  <a class="header-btn12" href="single-index9" target="_blank">One Page</a>
                               </div>
                            </div>
                          </div>
                        <div class="images">
                          <div class="homemenu-thumb" style="margin: 0;">
                            ...
                            <div class="text">
                             ...
                             <div class="homemenu-btn">
                                <a class="header-btn12" href="index10">Multi Page</a>
                                 <div class="space16"></div>
                                <a class="header-btn12" href="single-index10" target="_blank">One Page</a>
                             </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="btn-area">
                <a href="contact" class="header-btn6">GET IN TOUCH</a>
              </div>
            </div>
          </div>
        </div>
...
<div class="mobile-sidebar mobile-sidebar4">
  ...
  <div class="mobile-nav mobile-nav1">
    ...
    <div class="allmobilesection">
      <a href="contact"  class="header-btn6">Get Started</a>
        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="hero4-header text-center heading7">
                    ...
                    <h1 class="text-anime-style-1">Drive Your Business Forward With Our Expert <img src="{{ URL::asset('build/img/all-images/header-pera1.png') }}" alt=""><span>Digital Marketing <img src="{{ URL::asset('build/img/elements/line-img1.png') }}" alt=""></span> Solutions</h1>
                    <div class="space20"></div>
                    ...
                    <div class="btn-area1" data-aos="fade-up" data-aos-duration="1200">
                        <a href="contact" class="header-btn6">START RANKING NOW</a>
                        <a href="contact" class="header-btn7">GET STARTED NOW</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="header-images-area">
                    <div class="bg1">
                        <img src="{{ URL::asset('build/img/bg/header-bg4.png') }}" alt="">
                    </div>
                    <div class="img1" data-aos="zoom-in" data-aos-duration="1200">
                        <img src="{{ URL::asset('build/img/all-images/header-img7.png') }}" alt="" class="header-img7" data-aos="zoom-in" data-aos-duration="1000">
                    </div>
                    <div class="img2">
                    ...
                    <div class="img3">
                        <img src="{{ URL::asset('build/img/all-images/header-img4.png') }}" alt="" class="header-img6 aniamtion-key-1" data-aos="fade-right" data-aos-duration="1200">
                        <img src="{{ URL::asset('build/img/elements/elements9.png') }}" alt="" class="elements10">
                    </div>
                    <div class="img4">
                    ...
                    <div class="content" data-aos="fade-left" data-aos-duration="1200">
                        ...
                        <span><img src="{{ URL::asset('build/img/icons/star1.svg') }}" alt="">CEO & Founder</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-5">
          <div class="about-content-area heading8">
            ...
            <div class="btn-area" data-aos="fade-up" data-aos-duration="1200">
              <a href="about" class="header-btn6">LEARN MORE</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="btn-area1 text-center" data-aos="fade-up" data-aos-duration="1200">
                                <a href="service1" class="header-btn6">VIEW MORE SERVICES</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1200">
                ...
                <div class="btn-area1 text-center" data-aos="fade-up" data-aos-duration="1200">
                    <a href="case" class="header-btn6">VIEW MORE CASE STUDY</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="works4-header heading8">
                    ...
                    <div class="btn-area1" data-aos="fade-up" data-aos-duration="1200">
                        <a href="case" class="header-btn6">LEARN MORE</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6" data-aos="flip-right" data-aos-duration="800">
                <div class="pricing-boxarea">
                    ...
                    <div class="space32"></div>
                    <div class="btn-area1">
                        <a href="pricing" class="header-btn6">CHOOSE YOUR PLAN</a>
                    </div>
                    <div class="space32"></div>
                    <div class="list-area">
        ...
        <div class="col-lg-12 m-auto">  
          <div class="cta-header-area text-center sp4 heading2">
            ...
            <div class="btn-area text-center" data-aos="fade-up" data-aos-duration="1200">
              <a href="contact" class="header-btn7"> GET FREE CONSULTATION</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="footer-logo-area3">
            ...
            <form action="#">
              ...
              <button class="header-btn8"> Subscribe</button>
            </form>
          </div>
        </div>
      </div>
