...
<!--===== ABOUT AREA STARTS =======-->
<div class="about8-section-area" id="about">
    <div class="container">
...
<!--===== SERVICE AREA STARTS =======-->
<div class="service8-section-area sp1" id="service">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="service-all-boxes-area">
          <div class="service-boxarea" data-aos="zoom-in" data-aos-duration="800">
            <a href="service2">Search Engine Optimization ( SEO)</a>
          ...
          <div class="service-boxarea box3" data-aos="zoom-in" data-aos-duration="1200">
            <a href="service3">Social Media Marketing</a>
          ...
          <div class="service-boxarea box4" data-aos="zoom-in" data-aos-duration="1400">
            <a href="service3">Website Design and Development</a>
            <div class="space40"></div>
...
<!--===== CASE AREA STARTS =======-->
<div class="case8-section-area sp1" id="case">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-4">
...
<!--===== WORK AREA STARTS =======-->
<div class="work8-section-area sp1" id="work">
  <div class="container">
    <div class="row">
      <div class="col-lg-8 m-auto">
...
<div class="testimonial8-section-area sp1" id="testimonial">
  <div class="container">
      <div class="row">
...
<!--===== BLOG AREA STARTS =======-->
<div class="blog8-scetion-area sp2" id="blog">
  <div class="container">
    <div class="row">
