                          ...
                          <div class="all-images-menu">
                              ...
                              <div class="homemenu-thumb">
                                ...
                                <img src="{{ URL::asset('build/img/all-images/demo-img1.png') }}" alt="">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn16" href="index">Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <div class="space16"></div>
                                    <a class="header-btn16" href="single-index1" target="_blank">One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                 </div>
                              </div>
                            ...
                            <div class="images">
                              <div class="homemenu-thumb">
                                ...
                                <img src="{{ URL::asset('build/img/all-images/demo-img2.png') }}" alt="">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn16" href="index2"> Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <div class="space16"></div>
                                    <a class="header-btn16" href="single-index2" target="_blank"> One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                 </div>
                              </div>
                              <div class="space20"></div>
                            </div>
                            ...
                            <div class="images">
                              <div class="homemenu-thumb">
                                ...
                                <div class="homemenu-btn">
                                  <a class="header-btn16" href="index3">Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                  <div class="space16"></div>
                                  <a class="header-btn16" href="single-index3" target="_blank"> One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                               </div>
                              </div>
                              <div class="space20"></div>
                            </div>
                            ...
                            <div class="images">
                              <div class="homemenu-thumb">
                                ...
                                <img src="{{ URL::asset('build/img/all-images/demo-img3.png') }}" alt="">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn16" href="index4">Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <div class="space16"></div>
                                    <a class="header-btn16" href="single-index4" target="_blank"> One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                 </div>
                              </div>
                              <div class="space20"></div>
                            </div>
                            ...
                            <div class="images">
                              <div class="homemenu-thumb" style="margin: 0;">
                                ...
                                <img src="{{ URL::asset('build/img/all-images/demo-img4.png') }}" alt="">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn16" href="index5">Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <div class="space16"></div>
                                    <a class="header-btn16" href="single-index5" target="_blank"> One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                 </div>
                              </div>
                              <div class="space20"></div>
                            </div>
                          ...
                          <div class="all-images-menu">
                            <div class="images">
                              <div class="homemenu-thumb">
                                ...
                                <img src="{{ URL::asset('build/img/all-images/demo-img5.png') }}" alt="">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn16" href="index6">Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <div class="space16"></div>
                                    <a class="header-btn16" href="single-index6" target="_blank">One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                 </div>
                              </div>
                            </div>
                            ...
                            <div class="images">
                              <div class="homemenu-thumb">
                                ...
                                <div class="text">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn16" href="index7"> Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <div class="space16"></div>
                                    <a class="header-btn16" href="single-index7" target="_blank"> One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                 </div>
                              </div>
                            </div>
                            ...
                            <div class="images">
                              <div class="homemenu-thumb">
                                ...
                                <div class="homemenu-btn">
                                  <a class="header-btn16" href="index8">Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                  <div class="space16"></div>
                                  <a class="header-btn16" href="single-index8" target="_blank"> One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                               </div>
                              </div>
                            </div>
                            ...
                            <div class="images">
                              <div class="homemenu-thumb">
                                ...
                                <div class="text">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn16" href="index9">Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <div class="space16"></div>
                                    <a class="header-btn16" href="single-index9" target="_blank"> One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                 </div>
                              </div>
                            </div>
                            ...
                            <div class="images">
                              <div class="homemenu-thumb" style="margin: 0;">
                                ...
                                <div class="text">
                                 ...
                                 <div class="homemenu-btn">
                                    <a class="header-btn16" href="index10">Multi Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                    <div class="space16"></div>
                                    <a class="header-btn16" href="single-index10" target="_blank"> One Page <span><i class="fa-solid fa-arrow-right"></i></span></a>
                                 </div>
                              </div>
                            </div>
                          </div>
...
<!--===== ABOUT AREA STARTS =======-->
<div class="about1-section-area sp1 bg3">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-4">
  ...
  <div class="container">
    ...
    <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-duration="1200">
      <div class="service-author-boxarea box3">
          ...
          <div class="space40"></div>
          <div class="content-area">
              <a href="service2">Website Design & Development</a>
...
<div class="solution9-section-area sp1">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 m-auto">
...
<!--===== PRICING AREA STARTS =======-->
<div class="pricing9-section-area sp2">
  <div class="row">
    <div class="col-lg-6 m-auto">
...
<!--===== TESTIMONIAL AREA STARTS =======-->
<div class="testimonial9-section-area sp1">
  <div class="container">
    <div class="row">
...
<!--===== BLOG AREA STARTS =======-->
<div class="blog9-scetion-area sp2">
  <div class="container">
    <div class="row">
